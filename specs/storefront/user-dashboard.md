...
1. Main flow to be documented.

## Interfaces

- API, UI or configuration interfaces to be documented.
...
- Documentation: [docs/storefront/user-dashboard.md](../../docs/storefront/user-dashboard.md)
